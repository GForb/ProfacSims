...
sim_params <- list(
  nreps = 1,
  sim_rep_fun = list(ProfacSims:::sim_rep_continuous_new_data_save_data),
  ...
  ICC = c(0, 0.05, 0.2),
  R2 = c(0.4, 0.7),
  intercept_est_sample_size = c(10, 50, 200),
  n_studies_test = 30,
...
saveRDS(results, file = paste0("Results/ClusterSims/SimInv/data", sim_no_sting, ".RDS"))
